...
import { addToCart, removeToCart, removeSingleIteams, emptycartIteam, fetchCartStart, fetchCartSuccess, fetchCartFailure } from '../redux/features/cartSlice';
        ...
        const fetchCart = async (dispatch) => {
            ...
            try {
                const response = await axios.get('http://localhost:4000/api/cart', {
                    headers: { Authorization: `x-auth-token ${localStorage.getItem('token')}` }
                });
                        ...
                        <div className="card-header bg-dark p-3">
                            <div className='card-header-flex'>
                                <h5 className='text-white m-0'>
                                    <Link style={{ color: 'white', textDecoration: 'none' }} to={'/'}><LuArrowLeft /></Link>
                                                    ...
                                                    return (
                                                        <>
                                                            <tr>
                                                                ...
                                                                <td><div className='product-img'><img src={'http://localhost:4000/' + data.image} alt="" /></div></td>
                                                                <td><div className='product-name fs-6'><p>{data.name}</p></div></td>
                                                                <td>{data.price}</td>
                                                                <td>
